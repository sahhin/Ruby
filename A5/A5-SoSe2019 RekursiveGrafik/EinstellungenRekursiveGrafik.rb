$CLASSES = [:Vegetation, :Turtle,:KochKurve,:DrachenKurve,:HilbertKurve,:GosperKurve,:McWorterPentigree,:LevyFraktal]
...
$METHOD_CONFIG = {
  ...
  :change_color => {:label => "change_color(...)", :args => [[:color,:String]]},
  ...
  :Vegetation_class => { :new => { :label => :'new()'}},
