...
class Raum
  ...
  def finde_bewohner(bewohner_name)
    ...
    if der_bewohner.nil?
      drucke_hinweis("Bewohner", bewohner_name,0)
    end
    return der_bewohner
  end
  ...
  def finde_gegenstand(gegenstand_name)
     ...
     if gegenstand.nil?
       drucke_hinweis("Gegenstand", gegenstand_name,0)
     end
    return gegenstand
  end
  ...
  def gegenstand_aufheben(gegenstand_name,gewicht)
    ...
    if gegenstand.nil?
     drucke_hinweis("Gegenstand", gegenstand_name,gewicht)
    else
  ...
  def drucke_hinweis(klazz_string,objekt_name,gewicht)
    puts "#{klazz_string} #{objekt_name} nicht im Raum #{name} oder #{objekt_name} zu schwer."
  end
